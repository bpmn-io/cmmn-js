...
function CmmnTreeWalker(handler) {
  ...
  function handleStage(stage, context) {
    handlePlanFragment(stage, context);
  ...
  function handleDiscretionaryItem(discretionayItem, context) {
    ...
    forEach(discretionayItem.exitCriteria, function (criterion) {
      handleCriterion(criterion, context);
    });

    forEach(discretionayItem.entryCriteria, function (criterion) {
      handleCriterion(criterion, context);
    });
    ...
    else if (is(definitionRef, 'cmmn:PlanFragment')) {
