...
function CmmnTreeWalker(handler) {
  ...
  function handleDefinitions(definitions, diagram) {
    ...
    handleCases(definitions.cases, context);
  }
  ...
  function handleCase(_case, context) {
    ...
    if (casePlanModel) {
      context = handleCasePlanModel(casePlanModel, context);
    }
    ...
    handleDeferred(deferred, context);

    forEach(connections, function(d) { d(context); });
  }
