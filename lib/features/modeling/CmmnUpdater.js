...
CmmnUpdater.prototype.updateConnection = function(context) {
  ...
  if (isDiscretionaryConnection(connection)) {
    ...
    if (businessObject.sourceCMMNElementRef !== newSource) {
      businessObject.sourceCMMNElementRef = newSource;
    }
  }

  if (businessObject.targetCMMNElementRef !== newTarget) {
    businessObject.targetCMMNElementRef = newTarget;
  }
