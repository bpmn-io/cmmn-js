...
function UpdateControlsHandler(elementRegistry, modeling, cmmnReplace, cmmnFactory) {
...
UpdateControlsHandler.$inject = [ 'elementRegistry', 'modeling', 'cmmnReplace', 'cmmnFactory' ];
...
UpdateControlsHandler.prototype._updateDecorator = function(element, key, value) {
  ...
  if (definition[key] !== value) {
    ...
    changed = self._getReferencingItems(definition);
...
UpdateControlsHandler.prototype._updateRule = function(element, rule, value) {
  ...
  function deleteRule() {
    ...
    if (isRulePresent(defaultControl, rule)) {
      ...
      var changed = self._getReferencingItems(definition);
...
UpdateControlsHandler.prototype._getReferencingItems = function(definition) {
