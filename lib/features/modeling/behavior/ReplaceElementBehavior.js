...
function ReplaceElementBehavior(
  ...
  function canReconnect(attrs) {
    return rules.allowed('connection.reconnect', attrs);
  }
  ...
  this.preExecute('connection.reconnect', HIGH_PRIORITY, function(event) {
