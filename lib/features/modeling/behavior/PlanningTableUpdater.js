...
function PlanningTableUpdater(eventBus, cmmnFactory, modeling, itemRegistry) {
  ...
  this.preExecuted([ 'connection.delete', 'connection.reconnect' ], function(event) {
    ...
    // (2) if the target did not change, then do nothing (in case of reconnect end)
  ...
  this.preExecuted([ 'connection.create', 'connection.reconnect' ], function(context) {
  ...
  this.postExecuted([ 'connection.create', 'connection.reconnect' ], function(context) {
