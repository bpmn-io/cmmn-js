 ...
 */
function PlanItemDefinitionUpdater(eventBus, elementRegistry, cmmnFactory, modeling, cmmnReplace) {
...
PlanItemDefinitionUpdater.$inject = [ 'eventBus', 'elementRegistry', 'cmmnFactory', 'modeling', 'cmmnReplace' ];
