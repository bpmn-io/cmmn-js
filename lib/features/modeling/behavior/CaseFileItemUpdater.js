...
function CaseFileItemUpdater(
  ...
  this.preExecuted('shape.create', function(context) {
    ...
    modeling.updateSemanticParent(shape, caseFileModel, 'caseFileItems');
  ...
  this.postExecuted('shape.delete', function(context) {
    ...
    modeling.updateSemanticParent(shape, null, 'caseFileItems');
  ...
  function clearCaseFileItemContainer(container) {
    var items = container && container.get('caseFileItems');
  ...
  function moveChildren(caseFileItem, newParent, canMoveFilter) {
    ...
    var childrenElement = caseFileItem.children,
        children = childrenElement && childrenElement.get('caseFileItems');
    ...
    if (children && children.length) {
      ...
      forEach(children, function(child) {
        ...
        if (canMove) {
          modeling.updateSemanticParent(child, newParent, 'caseFileItems');
        }
  ...
  function isExlusiveRef(element) {
    ...
    return !find(elementRegistry._elements, function(elem) {
      return elem !== element && getDefinition(elem) === definition;
    });
