...
function CmmnReplace(cmmnFactory, replace, selection, cmmnRules) {
  ...
  function replaceElement(element, target, hints) {
    ...
    if (is(oldBusinessObject, 'cmmn:PlanItem') || is(oldBusinessObject, 'cmmn:DiscretionaryItem')) {
      ...
      if (is(getDefinition(oldBusinessObject), definitionType)) {
      ...
      if (is(oldDefinition, 'cmmn:PlanFragment')) {
        newElement.isCollapsed = isCollapsed(oldBusinessObject);
      }

      if (is(oldDefinition, 'cmmn:HumanTask') || is(oldDefinition, 'cmmn:Stage')) {
  ...
  function replacePlanItemControl(control, element) {
    ...
    if (control) {
      ...
      if (repetitionRule && cmmnRules.canSetRepetitionRule(element)) {
      ...
      if (requiredRule && cmmnRules.canSetRequiredRule(element)) {
      ...
      if (manualActivationRule && cmmnRules.canSetManualActivationRuleRule(element)) {
