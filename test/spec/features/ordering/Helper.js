...
function move(elementIds, delta, targetId, isAttach) {
  ...
  return TestHelper.getCmmnJs().invoke(function(canvas, elementRegistry, modeling) {
    ...
    return modeling.moveElements(elements, delta, target, { attach: isAttach });
  });
}
...
function compareZOrder(aId, bId) {
  ...
  TestHelper.getCmmnJs().invoke(function(elementRegistry) {
