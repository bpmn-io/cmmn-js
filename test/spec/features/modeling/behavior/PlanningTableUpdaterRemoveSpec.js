...
describe('features/modeling - #PlanningTableUpdater', function() {
  ...
  describe('remove', function() {
    ...
    describe('from plan fragment', function() {

      var stage, planningTable, discretionaryItem;

      beforeEach(inject(function(elementRegistry, elementFactory, modeling) {
        // given
        var shape = elementFactory.createDiscretionaryItemShape('cmmn:Task');
        var newParent = elementRegistry.get('DIS_PlanFragment_4');
        modeling.createShape(shape, { x: 700, y: 140 }, newParent);
      ...
      describe('add discretionary item to planning table', function() {
        ...
        it('should undo', inject(function(commandStack) {
          ...
          // then
          expect(stage.planningTable.get('tableItems')).to.have.length(3);
          expect(stage.planningTable.get('tableItems')).to.include(discretionaryItem);
        }));
    ...
    describe('from nested plan fragment', function() {
      ...
      beforeEach(inject(function(elementRegistry, elementFactory, modeling) {
        ...
        modeling.createShape(shape, { x: 470, y: 400 }, newParent);
