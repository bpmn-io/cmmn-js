...
describe('features/modeling - #PlanningTableUpdater', function() {
  ...
  describe('add', function() {
    ...
    describe('to plan fragment', function() {
      ...
      beforeEach(inject(function(elementRegistry, modeling) {
        ...
        var newParent = elementRegistry.get('DIS_PlanFragment_4');

        // when
        modeling.createShape(taskShape, { x: 700, y: 140 }, newParent);
      }));

      describe('surrounding stage keeps planning table', function() {
    ...
    describe('to nested plan fragment', function() {
      ...
      beforeEach(inject(function(elementRegistry, modeling) {
        ...
        var newParent = elementRegistry.get('DIS_PlanFragment_3');

        // when
        modeling.createShape(taskShape, { x: 470, y: 400 }, newParent);
      }));
  ...
  describe('different parents', function () {

    var diagramXML = require('./PlanningTableUpdater.different-parents.cmmn');

    beforeEach(bootstrapModeler(diagramXML, { modules: testModules }));

    var stage, casePlanModel, discretionaryItem;
    ...
    beforeEach(inject(function(elementFactory, elementRegistry, modeling) {
      ...
      var newParent = elementRegistry.get('DIS_PlanFragment_1');

      // when
      modeling.createShape(taskShape, { x: 175, y: 140 }, newParent);
    }));
